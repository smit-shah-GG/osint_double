...
<task type="auto">
  <name>Task 2: Implement FactExtractionAgent</name>
  <files>osint_system/agents/sifters/fact_extraction_agent.py</files>
  <action>
Implement the core extraction agent.
...
```
  ...
  <done>FactExtractionAgent implemented with prompt templates and schema output</done>
</task>
